...
class BrtEveModule(BrtEveCommon, BrtEveMoviePlayer): # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    #     """
    #     precision = 1
    #     if super().Vertex2f == super().Vertex2f_2:
    #         precision = 2
    #     elif super().Vertex2f == super().Vertex2f_4:
    #         precision = 4
    #     elif super().Vertex2f == super().Vertex2f_8:
    #         precision = 8
    #     elif super().Vertex2f == super().Vertex2f_16:
    #         precision = 16

    #     return super().VertexFormat(x * precision, y * precision, w, h, tag)
...
#            (self.eve.REG_ADAPTIVE_FRAMERATE, 0),
    ...
    def setup_800x480_NoSquare(self):
        ...
        self.swap()
        setup = [
            (self.eve.REG_OUTBITS, 6 | 6<<3 | 6<<6), # use rgb=666 to improve dither quality
            (self.eve.REG_DITHER, 1),
            (self.eve.REG_CSPREAD, 0),
            (self.eve.REG_PCLK_POL, 1),
#            (self.eve.REG_ADAPTIVE_FRAMERATE, 0),
