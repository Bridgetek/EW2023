 ...
 */
 ...
 // Reference: https://github.com/elehobica/pico_fatfs_test
#if !defined(__FT900__) && !defined(__FT930__) // Not building for FTDI MCU
...
#endif // !defined(__FT900__) && !defined(__FT930__) // Not building for FTDI MCU