...
def evehp_responsive_set_screen(dev_screen_w, dev_screen_h, run_screen_w, run_screen_h):
    evehp_responsive_set_dev_screen(dev_screen_w, dev_screen_h)
    evehp_responsive_set_run_screen(run_screen_w, run_screen_h)
