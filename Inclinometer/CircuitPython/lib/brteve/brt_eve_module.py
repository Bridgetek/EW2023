...
class BrtEveModule(BrtEveCommon, BrtEveMoviePlayer): # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def init(self, resolution = "", touch = ""):
        ...
        if resolution == "480x480":
            self.setup_480x480()
            print("Activating ST7701")
            self.host.ST7701_set()
    ...
    def recover(self):
        print("Recovering EVE")
        REG_COPRO_PATCH_PTR = 0x302000 + 0x7162
        patch = self.rd32(REG_COPRO_PATCH_PTR)

        self.wr16(self.eve.REG_CPURESET, 1)
        self.wr16(self.eve.REG_CMD_READ, 0)
        self.wr16(self.eve.REG_CMD_WRITE, 0)
        self.wr16(self.eve.REG_CMD_DL, 0)
        self.wr16(self.eve.REG_CPURESET, 0)
        time.sleep(.1)
        self.wr32(REG_COPRO_PATCH_PTR, patch)
        self.wr16(self.eve.REG_PCLK, 5)
...
#            (self.eve.REG_ADAPTIVE_FRAMERATE, 0),
    ...
    def ALPHA_FUNC(self, *args):           return self.eve.AlphaFunc(*args)          
    def BEGIN(self, *args):                return self.eve.Begin(*args)              
    def BITMAP_HANDLE(self, *args):        return self.eve.BitmapHandle(*args)       
    def BITMAP_LAYOUT(self, *args):        return self.eve.BitmapLayout(*args)       
    def BITMAP_SIZE(self, *args):          return self.eve.BitmapSize(*args)         
    def BITMAP_SOURCE(self, *args):        return self.eve.BitmapSource(*args)       
    def BITMAP_TRANSFORM_A(self, *args):   return self.eve.BitmapTransformA(*args)   
    def BITMAP_TRANSFORM_B(self, *args):   return self.eve.BitmapTransformB(*args)   
    def BITMAP_TRANSFORM_C(self, *args):   return self.eve.BitmapTransformC(*args)   
    def BITMAP_TRANSFORM_D(self, *args):   return self.eve.BitmapTransformD(*args)   
    def BITMAP_TRANSFORM_E(self, *args):   return self.eve.BitmapTransformE(*args)   
    def BITMAP_TRANSFORM_F(self, *args):   return self.eve.BitmapTransformF(*args)   
    def BLEND_FUNC(self, *args):           return self.eve.BlendFunc(*args)          
    def CALL(self, *args):                 return self.eve.Call(*args)               
    def CELL(self, *args):                 return self.eve.Cell(*args)               
    def CLEAR_COLOR_A(self, *args):        return self.eve.ClearColorA(*args)        
    def CLEAR_COLOR_RGB(self, *args):      return self.eve.ClearColorRGB(*args)      
    def CLEAR(self, *args):                return self.eve.Clear(*args)              
    def CLEAR_STENCIL(self, *args):        return self.eve.ClearStencil(*args)       
    def CLEAR_TAG(self, *args):            return self.eve.ClearTag(*args)           
    def COLOR_A(self, *args):              return self.eve.ColorA(*args)             
    def COLOR_MASK(self, *args):           return self.eve.ColorMask(*args)          
    def COLOR_RGB(self, *args):            return self.eve.ColorRGB(*args)           
    def DISPLAY(self, *args):              return self.eve.Display(*args)            
    def END(self, *args):                  return self.eve.End(*args)                
    def JUMP(self, *args):                 return self.eve.Jump(*args)               
    def LINEWIDTH(self, *args):            return self.eve.LineWidth(*args)          
    def LINE_WIDTH(self, *args):           return self.eve.Line_Width(*args)         
    def MACRO(self, *args):                return self.eve.Macro(*args)              
    def POINTSIZE(self, *args):            return self.eve.PointSize(*args)          
    def POINT_SIZE(self, *args):           return self.eve.Point_Size(*args)         
    def RESTORE_CONTEXT(self, *args):      return self.eve.RestoreContext(*args)     
    def RETURN(self, *args):               return self.eve.Return(*args)             
    def SAVE_CONTEXT(self, *args):         return self.eve.SaveContext(*args)        
    def SCISSOR_SIZE(self, *args):         return self.eve.ScissorSize(*args)        
    def SCISSOR_XY(self, *args):           return self.eve.ScissorXY(*args)          
    def STENCIL_FUNC(self, *args):         return self.eve.StencilFunc(*args)        
    def STENCIL_MASK(self, *args):         return self.eve.StencilMask(*args)        
    def STENCIL_OP(self, *args):           return self.eve.StencilOp(*args)          
    def TAGMASK(self, *args):              return self.eve.TagMask(*args)            
    def TAG(self, *args):                  return self.eve.Tag(*args)                
    def VERTEX2F(self, *args):             return self.eve.Vertex2f(*args)
    def VERTEX2II(self, *args):            return self.eve.Vertex2ii(*args)          
    def VERTEX_FORMAT(self, *args):        return self.eve.VertexFormat(*args)       
    def BITMAP_LAYOUT_H(self, *args):      return self.eve.BitmapLayoutH(*args)      
    def BITMAP_SIZE_H(self, *args):        return self.eve.BitmapSizeH(*args)        
    def PALETTE_SOURCE(self, *args):       return self.eve.PaletteSource(*args)      
    def VERTEX_TRANSLATE_X(self, *args):   return self.eve.VertexTranslateX(*args)   
    def VERTEX_TRANSLATE_Y(self, *args):   return self.eve.VertexTranslateY(*args)   
    def NOP(self, *args):                  return self.eve.Nop(*args)                
    def BITMAP_EXT_FORMAT(self, *args):    return self.eve.BitmapExtFormat(*args)    
    def BITMAP_SWIZZLE(self, *args):       return self.eve.BitmapSwizzle(*args)      
